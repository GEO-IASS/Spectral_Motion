...
@interface ImageViewerOptionsPopOver ()
{
    NSArray *m_Options;
...
@implementation ImageViewerOptionsPopOver
@synthesize delegate;
...
{
    static NSString *reuseIdentifer = @"OptionsCell";
    
    UITableViewCell *cell = [[UITableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifer];
    
    cell.textLabel.text = m_Options[indexPath.row];
